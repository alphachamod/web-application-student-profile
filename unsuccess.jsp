...
<div class="nav_bar"> 
	<div class="nav_buttons">
		<button onclick="window.location.href = 'exam_results';" class="navbtn_result">Exam Results</button>	
		<button onclick="window.location.href = 'extra_cu.html';"  class="navbtn_extra">Extra Curricular</button> 
		<button onclick="window.location.href = 'subdetails.html';" class="navbtn_subdetail">Subject Details</button> 
		
	</div>
	<div class="trouble">
		Having a Trouble? <br><br>
		<button onclick="window.location.href = 'con_teacher.html';" class="con_teacher" >Contact a Teacher</button>	
		<button onclick="window.location.href = 'con_support.html';" class="con_support">Contact Support Team</button>	
	</div>
...
<div class="main_container">
	<div class="welcome">Error Completing the Task!</div>
	
</div>

<div class="line"><hr align="center"></div>

<img class="wel_img" src="#">
