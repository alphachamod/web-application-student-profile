...
.pro_pic{
	...
	background-image: url("http://localhost:8090/student_profile/con_teacher.jsp/avatarew.jpg");
...
<div class="teacher_form">
		...
		<h1 class="label">SEND US A MESSAGE</h1>
		<p class="sub_label">W&nbsp;E&nbsp;'&nbsp; R&nbsp; E&nbsp;&nbsp;&nbsp;   H&nbsp; E&nbsp; R&nbsp; E&nbsp;&nbsp;&nbsp;   T&nbsp; O&nbsp;&nbsp; &nbsp;  G&nbsp; U&nbsp; I&nbsp; D&nbsp; E&nbsp;&nbsp; &nbsp;  Y&nbsp; O&nbsp; U</p><br><br>
</div>
<div>
	<img class="teacher_con_img" src="C:\Program Files\Apache Software Foundation\Tomcat 9.0\webapps\host-manager\img\rere.png">
</div>
<div class="teacher_form_content">
 		<form action="insert" method="post">
  		<input type="text" id="sname" name="sname" placeholder="Your Name"><br><br>
  		
  		
  		<input type="text" id="itno" name="itno" placeholder="Your Student ID No"><br><br>
  		
  	
  		<input type="text" id="email" name="email" placeholder="Your Email"><br><br>
  		

	  <textarea  rows="4" cols="50"  id="issue" placeholder="Describe the issue"> </textarea><br><br>
